...
function App() {
    ...
    return (
        <div className="site-shell">
            <section className="exact-hero exact-water-proof" id="home" aria-label="Laughlin river sunset with moving water">
                <img
                    src="/jetski/laughlin-sunset-clean.png"
                    alt="Laughlin riverfront and Aquarius hotel at sunset"
                    className="exact-hero-image"
                    draggable={false}
                />

                <video
                    className="exact-water-video"
                    autoPlay
                    muted
                    loop
                    playsInline
                    preload="auto"
                    poster="/jetski/laughlin-sunset-clean.png"
                    aria-hidden="true"
